...
#define BASS_ASIO_PRELEVELS		4 // pre-calculate channel levels
#define BASS_ASIO_ALLINPUTS		8 // start all input channels
#define BASS_ASIO_ALLOUTPUTS	16 // start all output channels
